...
<link href="https://fonts.googleapis.com/css2?family=Inter&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
      <a class="navbar-brand" href="#" style="margin-top:10px;"> MUSIKA PINOY</a>
...
<!-- Categories -->
<h3 class="a">Table Of Pending Post!</h3>
<div class="container ">
...
$length=6;
      ...
      $stmt = $connection->prepare("SELECT * FROM posttbl");
        ...
        if ($userCount > 0)
        {
          ...
          $id =   generate_string($permitted_chars,$length).$post['post_id'];
              echo "    <tr>
...
$( document ).ready(function() {
  ...
  $(document).on("submit", ".aps", function (e) {
    ...
    if (confirm('Are you sure you want to save this to the website?')) {
  // Save it!
  $.ajax({
    type:'POST',
    ...
    success:function(res){
     ...
     $(document).on("submit", ".dec", function (e) {
       ...
       if (confirm('Are you sure you want to Decline the Post?')) {
     // Save it!
     $.ajax({
       type:'POST',
       url:'adminIndex.php',
